    ...
    <main className="relative isolate min-h-screen w-full overflow-hidden text-[#17211c]">
      ...
      <header className="border-b border-white/60 bg-[#f8faf5]/80 backdrop-blur-xl">
        <div className="mx-auto flex h-16 max-w-3xl items-center justify-between gap-3 px-4 sm:px-6 lg:h-[4.5rem]">
          <Link href="/landing" aria-label="Ir al inicio de AsistAI" className="flex min-w-0 items-center gap-2.5">
            <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl border border-white/70 bg-white/90 shadow-[0_8px_24px_rgba(30,43,34,0.06)] backdrop-blur">
              <Image src="/brand/logo.svg" alt="AsistAI" width={34} height={34} className="h-auto w-7 object-contain" priority />
            </div>
      ...
      <footer className="border-t border-white/70 bg-[#1e2b22] text-white/70">
        <div className="mx-auto flex max-w-3xl flex-col gap-4 px-4 py-8 sm:px-6 md:flex-row md:items-center md:justify-between">
          <p className="text-sm">
            <span className="font-semibold text-white">AsistAI</span> — Recepción telefónica para negocios con cita previa.
          </p>
          <nav aria-label="Enlaces legales" className="flex flex-wrap gap-x-5 gap-y-2 text-sm font-medium">
            ...
            <a href="mailto:hola@asistai.es" className="transition hover:text-white">
              Contacto
            </a>
          </nav>
        </div>
