...
export const metadata: Metadata = {
  ...
  description:
    "Qué datos trata AsistAI, con qué finalidad, quién los procesa y cómo ejercer tus derechos. Incluye el tratamiento de la demo de voz y de las llamadas atendidas por la recepcionista virtual.",
  alternates: {
    canonical: absoluteUrl("/legal/privacidad"),
  },
  openGraph: {
    title: `Política de privacidad | ${siteName}`,
    description: "Qué datos trata AsistAI, con qué finalidad y cómo ejercer tus derechos.",
  ...
  return (
    ...
    >
      ...
      <LegalSection title="Quién es el responsable">
        <p>
          El responsable del tratamiento de tus datos es el titular de AsistAI. Puedes escribirnos a{" "}
