...
import RegisterBusinessPage from "@/app/register/business/page";
import {
  getPlaceDetails,
  searchPlaces,
...
function mockLocation() {
  ...
  let hrefValue = "http://localhost/register/business";
  const location = {
    ...original,
    search: "",
    get href() {
...
describe("RegisterBusinessPage — móvil con WhatsApp", () => {
  ...
  it("si el PATCH no devuelve el móvil (backend antiguo) avisa, no activa y continúa a los 4 s", async () => {
    ...
    expect(location.getHref()).toBe("http://localhost/register/business");
