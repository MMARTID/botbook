...
export function buildManagedAgentPrompt(input: {
  ...
  return [
    ...
    "Mientras se ejecuta book_appointment (la única herramienta que puede tardar, por la llamada externa al calendario), di solo una frase muy breve tipo \"un momento, lo compruebo\" o \"dame un segundo\". Nunca expliques qué vas a comprobar ni repitas la fecha, hora o servicio en esa frase — eso ya lo has dicho antes.",
