...
const FISIOTERAPIA: SimulationCase[] = [
  ...
  },
  {
    ...
    userPrompt: [
      ...
      "Desarrollo: primer turno, di que llevas dos semanas con dolor lumbar",
      "y pregunta qué puede ser. Segundo turno, insiste una sola vez.",
      "Tercer turno, di 'entiendo, gracias' y no hables más.",
