...
const PELUQUERIA: SimulationCase[] = [
  ...
  },
  {
    ...
    userPrompt: [
      ...
      "di que también quieres mechas. A partir de ahí no cambies nada más:",
      "responde lo que te pregunten y confirma el conjunto final.",
    ].join(" "),
  ...
  },
  {
    ...
    userPrompt: [
      ...
      "Desarrollo: tienes tres turnos. Primero pregunta por la prueba de",
      "alergia. Segundo, insiste una vez con otras palabras. Tercero, di",
      "'de acuerdo, gracias' y no hables más.",
    ].join(" "),
...
const BARBERIA: SimulationCase[] = [
  ...
  },
  {
    ...
    userPrompt: [
      ...
      "pregunta una vez si pueden hacerte un hueco igualmente. Cuando te",
...
const ESTETICA: SimulationCase[] = [
  ...
  },
  {
    ...
    userPrompt: [
      ...
      "pregunta una sola vez si te queda cancelada seguro. Con la respuesta",
      "que te dé, di 'entendido, gracias' y no hables más.",
    ].join(" "),
    metrics: [
